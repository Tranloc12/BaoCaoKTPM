...
|
 Unit Test (Perimeter) 
|
 Kiểm thử tính chu vi với các số dương hợp lệ 
|
 Length = 5, Width = 4 
|
 Chu vi = 18 
...
|
 Unit Test (Perimeter) 
|
 Kiểm thử tính chu vi với giá trị biên nhỏ nhất 
|
 Length = 1, Width = 1 
|
 Chu vi = 4 
...
|
 Unit Test (Perimeter) 
|
 Kiểm thử khi nhập kích thước âm 
|
 Length = -5, Width = 4 
|
 Ném ngoại lệ 
...
|
 Postman (JSON Server)
|
 Lấy danh sách tài nguyên (GET) 
|
 Endpoint: 
`GET /posts`
|
 Status 200 OK, Content-Type JSON 
|
`PASS`
|
|
...
|
 Body: 
`{ "title": "KTPM", "author": "Loc" }`
|
 Status 201 Created, ID tự sinh 
|
`PASS`
|
---
